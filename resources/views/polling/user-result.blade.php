...
@section('custom-javascript')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            let polling = ({!! json_encode($polling) !!});
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            if (data['polling_details']) {
                                if (data['polling_details'].some(detail => detail[
                                        'guid_polling'] === polling.guid)) {
                                    return "Submit";
                                }
                            }
                            return "Pending";
                    ...
                    },
                    {
                        ...
                        title: "Actions",
                        render: function(data, type, row) {
                            return '<a href="/mata-kuliah/polling/result/' + polling.guid + '/' +
                                data['nrp'] +
